        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <a
                href="#services"
                className="group bg-[#e11a1a] hover:bg-red-700 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all inline-flex items-center justify-center gap-2 shadow-2xl shadow-red-500/30"
              >
                Nos services
              ...
              <a
                href="#devis"
                className="bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white border-2 border-white/30 px-8 py-4 rounded-xl font-bold text-lg transition-all inline-flex items-center justify-center"
              >
                Demander un devis
              </a>
            </div>
          ...
          <div className="hidden lg:block">
            <div className="relative">
              {/* Floating Card 1 */}
              <div className="absolute -top-8 right-0 bg-white rounded-2xl p-6 shadow-2xl max-w-[280px] animate-float">
              ...
              {/* Floating Card 2 */}
              <div className="absolute top-40 -right-12 bg-[#e11a1a] text-white rounded-2xl p-6 shadow-2xl max-w-[240px] animate-float" style={{ animationDelay: '1s' }}>
              ...
              {/* Floating Card 3 */}
              <div className="absolute bottom-0 right-20 bg-white rounded-2xl p-6 shadow-2xl max-w-[260px] animate-float" style={{ animationDelay: '2s' }}>
