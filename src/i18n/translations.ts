    ...
    pages: {
      ...
      reseauxDistribution: {
        ...
        howWeOperate: {
          ...
          paragraph1: "Dotées de systèmes gestion automatisée, nos stations-services sont suivis et pilotés en temps réel pour garantir la disponibilité des produits ainsi qu'une traçabilité sécurisée des flux de ventes et de stocks.",
